...
proto.greet.GreetResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    result: (f = msg.getResult()) && proto.greet.Greeting.toObject(includeInstance, f)
  };
 ...
 * @return {!proto.greet.GreetResponse} returns this
 */
proto.greet.GreetResponse.prototype.clearResult = function() {
 ...
 * @return {boolean}
 */
proto.greet.GreetResponse.prototype.hasResult = function() {
  return jspb.Message.getField(this, 1) != null;
};
